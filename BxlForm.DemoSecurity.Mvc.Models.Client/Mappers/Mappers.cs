...
using G = BxlForm.DemoSecurity.Mvc.Models.Global.Data;

namespace BxlForm.DemoSecurity.Mvc.Models.Client.Mappers
{
    internal static class Mappers
    {
        ...
        {
            return new G.Category() { Id = entity.Id, Name = entity.Name };
        }

        internal static User ToClient(this G.User entity)
        {
            return new User(entity.Id, entity.LastName, entity.FirstName, entity.Email, entity.IsAdmin, entity.Token);
        }
        ...
        {
            return new G.Contact() { Id = entity.Id, LastName = entity.LastName, FirstName = entity.FirstName, Email = entity.Email, CategoryId = entity.CategoryId, UserId = entity.UserId };
        }
    }
}
