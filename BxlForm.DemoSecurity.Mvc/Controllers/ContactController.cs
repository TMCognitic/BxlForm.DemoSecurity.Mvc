using BxlForm.DemoSecurity.Mvc.Infrastructure.Security;
...
using BxlForm.DemoSecurity.Mvc.Models.Forms;
...
namespace BxlForm.DemoSecurity.Mvc.Controllers
{
    [AuthRequired]
    public class ContactController : Controller
    {
        ...
        {
            return View(_contactRepository.Get().Select(c => new DisplayContact() { Id = c.Id, LastName = c.LastName, FirstName = c.FirstName }));
        }
